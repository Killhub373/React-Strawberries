...
const testimonialData = [
  ...
  },
  {
    id: 7,
    name: "Nina",
    text: "Buah stroberi ini sangat segar dan juicy! Anak-anak saya sangat suka mengonsumsinya sebagai camilan sehat.",
  ...
  },
    {
      id: 8,
      name: "Yuki",
      text: "Saya suka stroberi ini karena rasanya yang manis alami tanpa perlu tambahan gula. Sangat direkomendasikan!",
      place: "Tokyo, Japan",
    ...
    },
  {
    id: 9,
    name: "Lisa",
    text: "Stroberi yang saya beli sangat cocok untuk membuat dessert. Semua teman saya memuji rasanya yang lezat.",
  ...
  },
  {
    id: 10,
    name: "Michael",
    text: "Pengirimannya cepat dan buah stroberinya sampai dalam kondisi yang sangat baik. Rasa dan teksturnya sempurna.",
    place: "Singapore",
        ...
        <div className="container">
          <div className="text-center mb-20 max-w-[400px] mx-auto">
            ...
            <p className="text-4xs">
              Berikut adalah beberapa pengalaman dan pendapat dari orang yang sudah memakan strawberry kami.
            </p>
          </div>
          <div
            data-aos="zoom-in"
